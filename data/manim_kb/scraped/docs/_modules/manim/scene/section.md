# Source code for manim.scene.section

Source: https://docs.manim.community/en/stable/_modules/manim/scene/section.html
...
' cannot be exported as dict, it does not have a video path assigned to it"
