# Source code for manim.mobject.vector_field

Source: https://docs.manim.community/en/stable/_modules/manim/mobject/vector_field.html
...
# TODO why not y_array = y_array.repeat(...)?
...
# Automatically True if z_range is set
