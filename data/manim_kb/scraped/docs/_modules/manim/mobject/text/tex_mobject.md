# Source code for manim.mobject.text.tex_mobject

Source: https://docs.manim.community/en/stable/_modules/manim/mobject/text/tex_mobject.html
...
self
.
_join_tex_strings_with_unique_deliminters
(
...
f
"MathTex: Could not find SVG group for tex part '
{
tex_string
}
' (id: 
...
ValueError
(
"Trying to get index of part not in MathTex"
)
...
f
"Could not locate part by provided tex string '
{
arg
}
'."
