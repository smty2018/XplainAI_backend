...
Source: https://docs.manim.community/en/stable/_modules/manim/mobject/geometry/boolean_ops.html
...
_convert_vmobject_to_skia_path
(
self
,
...
# what? No points so return empty path
