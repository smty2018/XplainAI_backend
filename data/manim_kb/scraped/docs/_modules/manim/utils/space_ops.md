...
Source: https://docs.manim.community/en/stable/_modules/manim/utils/space_ops.html
...
ValueError
(
"Vector must have the correct dimensions. (2, n)"
)
...
ValueError
(
"Coords must be in the xy-plane."
)
...
Exception
(
"Could not find a ring to attach"
)
