...
Source: https://docs.manim.community/en/stable/_modules/manim/animation/animation.html
...
__name__
 ...
 animation has been overridden for "
...
__name__
 ...
 mobjects. use_override = False can "

                    
f
" be used as keyword argument to prevent animation overriding."
,
...
# remove a mobject from the screen?
...
# included here to avoid TypeError if passed from a subclass' constructor
...
# needed if set_default() is called with no kwargs directly from Animation
...
anim
 ...
 cannot be converted to an animation"
)
...
ValueError
(
"A static Wait animation cannot have a stop condition."
)
