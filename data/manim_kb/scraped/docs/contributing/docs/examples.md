...
Source: https://docs.manim.community/en/stable/contributing/docs/examples.html
...
When you want to add/edit examples, they can be found in the docs/source/ directory, or directly in the manim source code (e.g. manim/mobject/mobject.py ). The examples are written in rst format and use the manim directive (see manim.utils.docbuild.manim_directive ), .. manim:: . Every example is in its own block, and looks like this:
...
All possible flags can be found at manim.utils.docbuild.manim_directive .
...
should be shown. Only for locally built documentation: If this still doesn’t work, you may need
