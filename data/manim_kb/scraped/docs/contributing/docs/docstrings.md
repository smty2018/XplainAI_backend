...
Source: https://docs.manim.community/en/stable/contributing/docs/docstrings.html
...
(i.e., dataclass) - priority should be given to the Attributes section, in this case, which must always be present , unless the
...
1. The usage of Parameters on functions to specify how
...
1. The usage of Returns to indicate what is the type of this
...
1. The usage of Examples in order to specify an example of usage of
