...
Source: https://docs.manim.community/en/stable/contributing/docs/typings.html
...
supported Python version, make use of typing_extensions .
...
- Manim has a dedicated typing module where type aliases are provided.
