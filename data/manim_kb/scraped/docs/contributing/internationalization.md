...
Source: https://docs.manim.community/en/stable/contributing/internationalization.html
...
You will first need to create an account for our project. Go to our project homepage and click the
...
1. What is your Discord username (optional)?
1. What is your GitHub username (optional)?
1. List the languages you speak, and your level of fluency with them.
1. What language(s) are you applying to be a proofreader for?
1. Do you have any previous experience with translations?
1. If yes, give us more details.
1. How will you ensure the quality of translations, should you become a
proofreader?
...
If you spot an error with a source string, report it to us by opening an issue on
