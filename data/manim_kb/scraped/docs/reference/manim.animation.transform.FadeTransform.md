...
class FadeTransform ( mobject = None , * args , use_override = True , ** kwargs ) [source] ¶ Bases: Transform Fades one mobject into another. Parameters : mobject – The starting Mobject . target_mobject – The target Mobject . stretch – Controls whether the target Mobject is stretched during
