...
DecimalTable | A specialized | Table | mobject for use with | DecimalNumber | to display decimal entries. | IntegerTable | A specialized | Table | mobject for use with | Integer | . | MathTable | A specialized | Table | mobject for use with LaTeX. | MobjectTable | A specialized | Table | mobject for use with | Mobject | . | Table | A mobject that displays a table on the screen.
